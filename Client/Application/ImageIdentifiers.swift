...
public struct ImageIdentifiers {
    ...
    public static let firefoxFavicon = "Freespoke Torch - Light Mode"
    public static let help = "help"
    public static let history = "menu-panel-History"
    public static let homeHeaderLogoBall = "Freespoke Torch - Light Mode"
    public static let homeHeaderLogoBallDark = "Freespoke Torch - Dark Mode"
    public static let homeHeaderLogoText = "Vector"
    ...
    public static let menuShare = "share-dark"
    ...
    public static let navMenu = "icon-nav-menu"
