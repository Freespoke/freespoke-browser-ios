...
final class TrendingStoryTweetCollectionViewCell: UICollectionViewCell, Themeable {
    static let reuseIdentifier: String = String(describing: type(of: TrendingStoryTweetCollectionViewCell.self))
    ...
    private lazy var authorLogoImageView: UIImageView = {
        let img = UIImageView()
        img.contentMode = .scaleAspectFill // .scaleAspectFit
    ...
    func configure(tweet: StoryFeedTweetModel) {
        self.tweet = tweet
