...
class SecondaryButton: BaseTouchableButton, Themeable {
    ...
    func applyTheme() {
        DispatchQueue.main.async { [weak self] in
            ...
            case true:
                ...
                self.setTitleColor(self.themeManager.currentTheme.type == .dark ? UIColor.whiteColor : UIColor.blackColor, for: .normal)
            ...
            case false:
                ...
                self.setTitleColor(self.themeManager.currentTheme.type == .dark ? UIColor.whiteColor.withAlphaComponent(0.5) : UIColor.blackColor.withAlphaComponent(0.5), for: .normal)
