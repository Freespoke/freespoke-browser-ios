...
//    }()
//    
//    private var leadingAnchorForSwitcher: NSLayoutConstraint?
//            
...
//        
//        self.leadingAnchorForSwitcher = self.adBlockerSwitcher.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 8)
//        self.leadingAnchorForSwitcher?.isActive = true
//        
//        self.updateLeadingAnchorForSwitcher()
//        
...
//    }
//    
//    private func updateLeadingAnchorForSwitcher() {
//        if ScreenUtilities.isLandscape {
//            self.leadingAnchorForSwitcher?.constant = self.safeAreaInsets.left + 8
//        } else {
//            self.leadingAnchorForSwitcher?.constant = 8
//        }
//    }
//    
...
//        
//        Task {
//            if let shouldBlockAds = try? await AdBlockManager.shared.shouldBlockAds() {
//                if (host == "local") {
//                    self.isHidden = true
//                } else {
//                    self.isHidden = false
