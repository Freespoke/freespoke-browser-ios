...
// AUTOGENERATED BY glean_parser v7.0.0. DO NOT EDIT. DO NOT COMMIT.
...
extension GleanMetrics {
    class GleanBuild {
        ...
        public static let info = BuildInfo(buildDate: DateComponents(calendar: Calendar.current, timeZone: TimeZone(abbreviation: "UTC"), year: 2023, month: 3, day: 6, hour: 14, minute: 28, second: 55))
    }
