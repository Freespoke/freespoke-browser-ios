...
open class DefaultSuggestedSites {
    ...
    public static let sites = [
        "default": [
            SuggestedSiteData(
                url: "https://freespoke-support.freshdesk.com/support/tickets/new/",
                bgColor: "0x385185",
                imageUrl: "asset://suggestedsites_facebook",
                faviconUrl: "asset://defaultFavicon",
                trackingId: 632,
                title: "Freespoke Support"
            ),
            SuggestedSiteData(
                url: "https://freespoke.substack.com/",
                bgColor: "0x55acee",
                imageUrl: "asset://suggestedsites_twitter",
                faviconUrl: "asset://defaultFavicon",
                trackingId: 631,
                title: "Freespoke Blog"
            ),
            SuggestedSiteData(
                url: "https://www.facebook.com/FreespokeSearch/",
                bgColor: "0x000000",
                imageUrl: "asset://suggestedsites_wikipedia",
                faviconUrl: "asset://defaultFavicon",
                trackingId: 630,
                title: "Freespoke Facebook"
            )
        ],
        "zh_CN": [
            SuggestedSiteData(
